...
git config --global --replace-all alias.pom 'push origin main'
git config --global --replace-all alias.pomm 'push origin master'
...
git config --global --replace-all alias.plom 'pull origin main'
git config --global --replace-all alias.plomm 'pull origin master'
